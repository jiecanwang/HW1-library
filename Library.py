...
# from mmc639_Final_Exam import aggregate_raw_data_tables,initialize_raw_data_tables,initialize_aggregated_tables,reset_raw_data_tables,ts_to_datetime
...
# From mmc639_Final_Exam I copy its main function as my raw data
